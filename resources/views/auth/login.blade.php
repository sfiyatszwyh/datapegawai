...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('template/assets/img/favivcon.png') }}" rel="icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="/login" method="POST" onsubmit="return validateForm()">
                    @csrf
                    <div class="col-12">
